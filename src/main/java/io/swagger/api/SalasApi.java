...
@Validated
public interface SalasApi {

    @Operation(summary = "", description = "", tags={ "salas" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "201", description = "item created", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Devolver.class))),
        ...
        @ApiResponse(responseCode = "409", description = "an existing item already exists", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Devolver.class))) })
    ...
    @RequestMapping(value = "/salas/{idCodigoSala}",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    ResponseEntity<Devolver> deleteSala(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("idCodigoSala") String idCodigoSala, @NotNull @Parameter(in = ParameterIn.QUERY, description = "" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "restKey", required = true) String restKey);


    @Operation(summary = "get sala by id", description = "", tags={ "salas" })
    @ApiResponses(value = { 
    ...
    ResponseEntity<InlineResponse200> searchSala(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("idCodigoSala") String idCodigoSala, @NotNull @Parameter(in = ParameterIn.QUERY, description = "" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "restKey", required = true) String restKey);


    @Operation(summary = "update sala", description = "", tags={ "salas" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "ok", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Devolver.class))),
