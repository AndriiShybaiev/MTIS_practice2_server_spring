...
public interface NivelesApi {
    ...
    @RequestMapping(value = "/niveles/{idNivel}",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    ResponseEntity<Devolver> deleteNivel(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("idNivel") String idNivel, @NotNull @Parameter(in = ParameterIn.QUERY, description = "" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "restKey", required = true) String restKey);


    @Operation(summary = "get nivel by id", description = "", tags={ "niveles" })
    @ApiResponses(value = { 
    ...
    ResponseEntity<InlineResponse2001> searchNivel(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("idNivel") String idNivel, @NotNull @Parameter(in = ParameterIn.QUERY, description = "" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "restKey", required = true) String restKey);
